...
class TGDropBoxView: UIView {
    ...
    var isHightWhenShowList: Bool = false {
        willSet(newValue) {
            self.backgroundView?.backgroundColor = (newValue == true) ? UIColor.clear : UIColor.clear//UIColor.black : UIColor.clear
        }
    }
    ...
    init(parentVC: UIViewController, title: String, items: [String], frame: CGRect) {
        ...
        self.listTableView.width = parentFrame.width
        ...
        self.boxWrapperView.y = 545
        self.boxWrapperView.x = 20
        self.boxWrapperView.isHidden = true
        listTableView.layer.cornerRadius = 0
        listTableView.layer.borderWidth = 1
        listTableView.layer.borderColor = UIColor.lightGray.cgColor
    }
