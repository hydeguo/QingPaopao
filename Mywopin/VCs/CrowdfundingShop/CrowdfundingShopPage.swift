...
class CrowdfundingShopPage: UIViewController ,UIScrollViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        _ = Wolf.requestBase(type: WooAPI.getNumerousCategory, completion: { (category: ExchangeCategory?, msg, code) in
            if(code == "0")
            {
